...
def calculate_standings():
    standings = {team: [0, 0, 0] for team in teams}
...
def display_standings(standings):
    ...
    for team, stats in standings.items():
        ...
        win_percent = (wins + 0.5 * ties) / total_games if total_games != 0 else 0  # Corrected line
    ...
    if team_code in teams:
        ...
        for date, team1, team2, score1, score2 in games:
            if team1 == team_code or team2 == team_code:
                if (team_code == team1 and score1 > score2) or (team_code == team2 and score2 > score1):
                    result = "WIN"
                    wins += 1
                elif (team_code == team1 and score1 < score2) or (team_code == team2 and score2 < score1):
                    result = "LOSS"
                    losses += 1
                else:
                    result = "TIE"
        ...
        # Print the overall record for the team
        print(f"\nOverall Record: {wins} Wins, {losses} Losses, {ties} Ties")
    else:
